        ...
        <div class="bg-primary/20 w-[55%] h-screen absolute right-0 top-0 p-20">
            <div class="text-xs flex items-center justify-between w-[30rem] font-light">
                ...
                <div class="flex items-center font-semibold">
                    <p class="bg-primary px-4 py-2 rounded-lg mr-2 text-white">3</p>
                    <p>Payment Details</p>
                </div>
            </div>
            <div class="bg-primary/40 w-full h-[0.05rem] mt-6"></div>
            <div class="pt-10 pb-8">
                <h4 class="text-[#d1c2a7]">Step 3/3</h4>
            ...
            <form action="">
                <div class="grid grid-cols-2 gap-x-7 gap-y-4 text-sm">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="address" id="address" rows="2" class="mt-1 block w-full py-2 px-3 rounded-md bg-transparent border-[#d1c2a7] border-[0.1rem] focus:border-[#8b7045] focus:outline-0"></textarea>
                    </div>
                </div>
                <div class="bg-primary/40 w-full h-[0.05rem] mt-10"></div>
                <div class="flex justify-end">
                    <button type="submit" class="bg-[#8b7045] text-white text-sm w-36 h-12 rounded-lg mt-7 hover:shadow-xl">Submit</button>
                </div>
            </form>
        </div>
    </div>
